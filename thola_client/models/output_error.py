...
class OutputError(object):
    ...
    @property
    def error(self):
        """Gets the error of this OutputError.  # noqa: E501


        :return: The error of this OutputError.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this OutputError.


        :param error: The error of this OutputError.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OutputError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutputError):
            return False
